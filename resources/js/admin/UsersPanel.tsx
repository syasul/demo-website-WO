    ...
    return (
        <div className="space-y-6 animate-fade-in text-xs">
            <div className="flex justify-between items-center">
                <h3 className="font-display text-xl font-bold text-dark">Manajemen Staff Akun</h3>
            ...
            <div className="bg-white border border-rose/20 shadow-sm max-w-4xl">
                    ...
                    <tbody className="divide-y divide-rose/20 text-xs">
                        {users.map(u => (
                            <tr key={u.id}>
                                ...
                                <td className="p-4">
                                    <span className={`px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider border ${u.is_active ? 'bg-rose/10 border-rose text-rose' : 'bg-red-50 border-red-200 text-red-500'}`}>
                    ...
                    <div className="max-w-md w-full bg-white border border-gold p-8 shadow-2xl relative">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
                            <div className="space-y-1">
                                <label className="text-[9px] uppercase font-bold text-dark/60">Nama Staff *</label>
                                <input 
                                    type="text" 
                                    value={form.name} 
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1">
                                    <label className="text-[9px] uppercase font-bold text-dark/60">Email *</label>
                                    <input 
                                        type="email" 
                                        value={form.email} 
                                ...
                                <div className="space-y-1">
                                    <label className="text-[9px] uppercase font-bold text-dark/60">Nomor HP</label>
                                    <input 
                                        type="text" 
                                        value={form.phone} 
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1">
                                    <label className="text-[9px] uppercase font-bold text-dark/60">Password {selectedUserId && '(Kosongkan jika tetap)'} *</label>
                                    <input 
                                        type="password" 
                                        value={form.password} 
