        ...
        <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <GlassCard className="p-5" hover>
                    ...
                    <span className="font-utility text-xl font-bold text-rose block mt-3">
                ...
                <GlassCard className="p-5" hover>
                    ...
                    <span className="font-display text-3xl font-bold text-rose block mt-3">{stats.stats.deals_this_month}</span>
                </GlassCard>
                <GlassCard className="p-5" hover>
