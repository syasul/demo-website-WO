            ...
            <div className="max-w-6xl mx-auto px-6 md:px-12 py-12 relative z-10">
                ...
                <div className="text-center mb-16 mt-12">
                    ...
                    <h1 className="font-display text-4xl md:text-5xl font-bold text-dark mt-2">
                        Tentang <span className="text-gradient-gold">LUXURY</span>{' '}
                    ...
                    <p className="text-dark/40 text-[10px] mt-3 uppercase tracking-widest font-utility">LUXURY Wedding Organizer</p>
                </div>
                    ...
                    <GlassCard variant="default" className="md:col-span-2 md:row-span-2 p-8 flex flex-col justify-between" hover>
                        <div className="space-y-6">
                            ...
                            <p className="text-dark/60 text-xs leading-relaxed">
                                Berawal dari kecintaan terhadap seni merangkai momen indah, <strong className="text-rose">LUXURY Wedding Organizer</strong> hadir untuk memberikan pengalaman wedding planning yang menyenangkan dan bebas stres bagi setiap pasangan.
                            </p>
                    ...
                    <GlassCard variant="default" className="md:col-span-1 md:row-span-2 p-6 flex flex-col justify-between relative overflow-hidden" hover>
                        <div className="relative h-[320px] rounded-xl overflow-hidden">
                            ...
                            <div className="absolute bottom-3 left-3">
                                ...
                                <p className="font-display text-sm font-semibold text-white/90">LUXURY Wedding Team</p>
                            </div>
                        </div>
